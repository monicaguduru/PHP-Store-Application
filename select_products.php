	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="i#"><span>Grocery</span> Store</a></h1>
			</div>
...
<!-- products-breadcrumb -->
   ...
   $query = mysqli_query($connect,"SELECT * FROM product_barcode");
 ...
 while ($row = mysqli_fetch_array ($query)) {
      echo "<tr>";
      echo "<td>"; echo "&nbsp"; echo "&nbsp";echo "&nbsp"; echo "&nbsp";echo $row["itemId"];echo "&nbsp"; echo "&nbsp"; echo "</td>";
  ...
  <form action="items_to_pi.php" method="post" enctype="multipart/form-data">
    ...
    <br>
    <br>
    <form action="route1.php" method="post" enctype="multipart/form-data">
      	
      	
        <input type="submit" name="submit" value="ROUTE"/>
    </form> <?php
     echo "</center>";
