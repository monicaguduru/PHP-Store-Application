...
<!-- products-breadcrumb -->
   ...
   $query = mysqli_query($connect,"SELECT * FROM Trolley where uid=$var1");
   $count1 = mysqli_query($connect,"SELECT count(*) FROM Trolley where uid=$var1");
   $count = mysqli_fetch_array ($count1);
   $Cart_total=0;
      echo "<center>";
      ...
      echo "<th>";echo "&nbsp";echo "&nbsp"; echo "ID"; echo "&nbsp";echo "&nbsp"; echo "</th>";
      echo "<th>"; echo "&nbsp";echo "&nbsp";echo "Product"; echo "&nbsp";echo "&nbsp";echo "</th>";
 ...
 while ($row = mysqli_fetch_array ($query)) {
      ...
      echo "<td>"; echo "&nbsp";echo "&nbsp";echo $row["product"];echo "&nbsp";echo "&nbsp"; echo "</td>";
      echo "<td>"; echo "&nbsp";echo "&nbsp";echo $row["price"]; echo "&nbsp";echo "&nbsp";echo "</td>";
  ...
  echo "<tr>";
  echo "<td>"; echo "<b>NUMBER OF ITEMS IN CART : <br>"; echo "</td>";
  echo "<td>"; echo $count[0]; 
  echo"</td>";
  echo "</tr>";
  echo "<tr>";
